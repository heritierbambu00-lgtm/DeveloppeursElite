...
export const translations = {
  fr: {
    ...
    "services.engineering.desc": "Conception et développement d'applications sur mesure, architectures cloud et solutions scalables.",
    "services.ai": "Intelligence Artificielle",
    "services.ai.desc": "Entraînement de modèles LLM, computer vision et analyse prédictive pour vos données.",
    "services.infra": "Infrastructures & Réseaux",
    "services.infra.desc": "Déploiement de réseaux locaux, sécurisation des données et maintenance critique.",
    "services.rd": "Recherche & Développement",
    "services.rd.desc": "Exploration de solutions innovantes pour les problématiques locales africaines.",
    "services.training": "Formation & Transmission",
    "services.training.desc": "Mentorat et bootcamps intensifs pour la nouvelle génération d'ingénieurs.",
  ...
  en: {
    ...
    "services.engineering.desc": "Design and development of custom applications, cloud architectures, and scalable solutions.",
    "services.ai": "Artificial Intelligence",
    "services.ai.desc": "LLM training, computer vision, and predictive analysis for your data.",
    "services.infra": "Infra & Networks",
    "services.infra.desc": "Deployment of local networks, data security, and critical maintenance.",
    "services.rd": "Research & Design",
    "services.rd.desc": "Exploration of innovative solutions for local African challenges.",
    "services.training": "Training & Mentor",
    "services.training.desc": "Mentoring and intensive bootcamps for the next generation of engineers.",
