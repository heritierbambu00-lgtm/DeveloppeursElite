...
const CEODashboard = ({ profile }) => {
  ...
  return (
    <div className="bg-[#F3F4F6] min-h-full -m-10 p-10 text-slate-900 font-sans animate-in fade-in duration-700">
      {/* Header */}
            ...
            <div className="flex justify-center mb-8">
               <div className="w-40 h-40 rounded-full border-[12px] border-slate-50 relative flex items-center justify-center">
                  <div className="text-center">
                     ...
                     <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Total Projets</p>
                  </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
         ...
         <div className="bg-white border border-slate-200 p-8 rounded-[2.5rem] shadow-sm">
            ...
            <div className="space-y-6">
               ...
               <Link
                 to="/admin/inbox"
                 className="flex items-center justify-center gap-3 w-full bg-slate-50 border border-slate-200 py-3 rounded-2xl text-xs font-bold hover:bg-slate-100 transition-all"
               >
